...
export class PurchaseViewAdminComponent implements OnInit {
    ...
    constructor(private service: PurchaseAdminService, private customerService: CustomerAdminService, private productService: ProductAdminService, private purchaseItemService: PurchaseItemAdminService){
