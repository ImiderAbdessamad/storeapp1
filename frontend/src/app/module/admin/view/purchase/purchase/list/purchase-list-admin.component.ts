...
export class PurchaseListAdminComponent implements OnInit {
    ...
    constructor( private service: PurchaseAdminService  , private customerService: CustomerAdminService, private productService: ProductAdminService, private purchaseItemService: PurchaseItemAdminService, @Inject(PLATFORM_ID) private platformId?) {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'customer?.id', header: 'Customer'},
        ];
    }


    public async loadCustomer(){
        this.customerService.findAll().subscribe(customers => this.customers = customers, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        ...
        //'Customer': this.criteria.customer?.id ? this.criteria.customer?.id : environment.emptyForExport ,
        }];
      }
