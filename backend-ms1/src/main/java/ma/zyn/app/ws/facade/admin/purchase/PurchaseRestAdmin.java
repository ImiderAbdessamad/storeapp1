...
public class PurchaseRestAdmin {
    ...
    public List<PurchaseDto> findByCustomerId(@PathVariable Long id){
        return findDtos(service.findByCustomerId(id));
    }
    @Operation(summary = "delete by customer id")
    @DeleteMapping("customer/id/{id}")
    public int deleteByCustomerId(@PathVariable Long id){
